...
public class TileInsaniumFurnace extends TileEntityLockable implements ITickable, ISidedInventory {
	...
	public String getName() {
		return this.hasCustomName() ? this.furnaceCustomName : I18n.translateToLocal("container.mysticaladaptations.insaniumfurnace.name");
	}
    ...
    public static void registerFixesFurnace(DataFixer fixer) {
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TileInsaniumFurnace.class, new String[] { "Items" }));
    }
    ...
    protected void setState(boolean active, World world, BlockPos pos) {
    	BlockInsaniumFurnace.setState(active, world, pos);
	}
