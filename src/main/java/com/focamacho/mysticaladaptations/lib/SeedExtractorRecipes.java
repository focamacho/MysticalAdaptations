...
public class SeedExtractorRecipes {
	...
	public static final SeedExtractorRecipe electrotine_seeds = new SeedExtractorRecipe(RecipesConfig.electrotine_seeds, Type.ELECTROTINE);
	...
	public static final SeedExtractorRecipe experience_seeds = new SeedExtractorRecipe(RecipesConfig.experience_seeds, Type.EXPERIENCE);
	...
	public static final SeedExtractorRecipe saltpeter_seeds = new SeedExtractorRecipe(RecipesConfig.saltpeter_seeds, Type.SALTPETER);
	...
	public static final SeedExtractorRecipe hop_graphite_seeds = new SeedExtractorRecipe(RecipesConfig.hop_graphite_seeds, Type.HOP_GRAPHITE);
	...
	public static final SeedExtractorRecipe sulfur_seeds = new SeedExtractorRecipe(RecipesConfig.sulfur_seeds, Type.SULFUR);
