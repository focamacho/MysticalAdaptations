...
public class ModItems {
	...
	public static RegistryObject<Item> INSANIUM_BOW = items.register("insanium_bow", () -> new EssenceBowItem(ModItemTier.INSANIUM, 6, 1, 2.0f, 3.5f){@Override public int getAugmentSlots() { return ConfigHolder.insaniumToolsAugments; }});
	public static RegistryObject<Item> INSANIUM_CROSSBOW = items.register("insanium_crossbow", () -> new EssenceCrossbowItem(ModItemTier.INSANIUM, 6, 1, 2.0f, 3.5f){@Override public int getAugmentSlots() { return ConfigHolder.insaniumToolsAugments; }});
