...
public class ModItems {
	...
	public static RegistryObject<Item> INSANIUM_BOW = items.register("insanium_bow", () -> new EssenceBowItem(ModItemTier.INSANIUM, 6, 1, 2.0f, p -> p.tab(MysticalAdaptations.creativeTab)){@Override public int getAugmentSlots() { return ConfigHolder.insaniumToolsAugments; }@Override public int getEnchantmentValue() { return ConfigHolder.enchantableInsaniumTools ? 30 : 0; }});
	public static RegistryObject<Item> INSANIUM_CROSSBOW = items.register("insanium_crossbow", () -> new EssenceCrossbowItem(ModItemTier.INSANIUM, 6, 1, 2.0f, p -> p.tab(MysticalAdaptations.creativeTab)){@Override public int getAugmentSlots() { return ConfigHolder.insaniumToolsAugments; }@Override public int getEnchantmentValue() { return ConfigHolder.enchantableInsaniumTools ? 30 : 0; }});
